  ...
  provideLinter() {
    ...
    return {
      ...
      lint: async (textEditor) => {
        ...
        const optionsMap = require('./flags');

        // Add the flags to the command options
        Object.keys(atom.config.getAll('linter-puppet-linting')).forEach((flag) => {
          if (Object.hasOwnProperty.call(optionsMap, flag) && atom.config.getAll('linter-puppet-linting')[flag] === true) {
